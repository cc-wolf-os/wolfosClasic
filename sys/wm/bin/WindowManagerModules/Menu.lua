...
local RegistryWriter = require(".sys.lib.registry.Writer")
...
function menu:init()
  ...
  self.shutdownButton = button:new{
    ...
    text = "O", 
    callback = function()
      self.wm.addProcess("/sys/wm/bin/shutdown.lua", {
        hideFrame = true, 
        w = 24, 
        h = 9, 
        isCentered = true,
