...
local buttonManager = require(".sys.lib.ui.button")
local reader = require(".sys.lib.registry.Reader"):new("user")
local events = require('.sys.lib.events'):new()
...
local logout = buttonManager:new{
  x = 3, 
  y = 7, 
  text = "Logout", 
  callback = function()
